...
describe('Performs login in the application with invalid data', async () => {
    ...
    it('Validate login in the app with a locked user', async () => {
    ...
    it('Validate login in the app with invalid credentials', async () => {
    ...
    it('Validate login in the app with username field empty', async () => {
    ...
    it('Validate login in the app with password field empty', async () => {
